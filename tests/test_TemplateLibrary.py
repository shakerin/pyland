...
class TestTemplateLibrary:
    ...
    def test_TemplateLibrary_loadFrameFilesFromDir_frame_dirs(self):
        ...
        ins = TL()
        ins.loadFrameFilesFromDir(PV_testdir_TemplateLibraryTest)
        expected_frame_dirs = []
    ...
    def test_TemplateLibrary_frame_dirs(self):
        ...
        ins_22= TL([PV_testdir_TemplateLibraryTest])
        ins_22.addFrameDirs([PV_testdir_TemplateLibraryTest2])
        exp_frame_dirs = [
            PV_testdir_TemplateLibraryTest,
            PV_testdir_TemplateLibraryTest2
        ]
    ...
    def test_TemplateLibrary_loadFrameFilesFromDir_frame_files(self):
        ...
        expected_abspath_list = [join(PV_testdir_TemplateLibraryTest, f) for f in expected_list] 
    ...
    def test_TemplateLibrary_loadAllTemplates_frame_files(self):
        ...
        ins = TL([PV_testdir_TemplateLibraryTest,PV_testdir_TemplateLibraryTest2])
        expected_list = ["test_file_1.txt", "test_file_2.txt", "test_file_3"]
        expected_abspath_list = [join(PV_testdir_TemplateLibraryTest, f) for f in expected_list] 
        expected_list1 = ["test_file_4.txt", "test_file_5.txt", "test_file_6"]
        expected_abspath_list1 = [join(PV_testdir_TemplateLibraryTest2, f) for f in expected_list1]         
    ...
    def test_TemplateLibrary_loadAllTemplates_frame_names(self):
        ...
        ins_4 = TL([PV_testdir_TemplateLibraryTest,PV_testdir_TemplateLibraryTest2])
    ...
    def test_TemplateLibrary_loadAllTemplates_DynamicObjectInternalVariable_name(self):
        ...
        ins_5= TL([PV_testdir_TemplateLibraryTest,PV_testdir_TemplateLibraryTest2])
    ...
    def test_TemplateLibrary_loadAllTemplates_DynamicObjectsCreated(self):
        ...
        ins_6= TL([PV_testdir_TemplateLibraryTest])
    ...
    def test_TemplateLibrary_loadAllTemplates_ListOfFrameFiles(self):
        ...
        ins_8= TL([PV_testdir_TemplateLibraryTest])
        dirpath = PV_testdir_TemplateLibraryTest
        filepaths = [
    ...
    def test_TemplateLibrary_loadAllTemplates_DynamicObjects_FrameLocationSearch(self):
        ...
        ins_9 = TL([PV_testdir_TemplateLibraryTest,PV_testdir_TemplateLibraryTest2])
        assert ins_9.findFrame("test_file_6") == PV_testdir_TemplateLibraryTest2 + "/test_file_6" 
    ...
    def test_TemplateLibrary_loadAllTemplates_DynamicObjectsUsage(self):
        ...
        ins_7= TL([PV_testdir_TemplateLibraryTest])
    ...
    def test_TemplateLibrary_loadAllTemplates_addFrameDirs_FalseCheck(self):
        ...
        ins_10= TL([PV_testdir_TemplateLibraryTest])
        dirpath = PV_testdir_TemplateLibraryTest
        dirpath2 = PV_testdir_TemplateLibraryTest2
        filepaths = [
            dirpath + "/test_file_1.txt",
            dirpath + "/test_file_2.txt",
            dirpath + "/test_file_3",
    ...
    def test_TemplateLibrary_loadAllTemplates_addFrameDirs_TrueCheck(self):
        ...
        working fine tested"""
        ins_11= TL([PV_testdir_TemplateLibraryTest])
        ins_11.addFrameDirs([PV_testdir_TemplateLibraryTest2])
        dirpath = PV_testdir_TemplateLibraryTest
        dirpath2 = PV_testdir_TemplateLibraryTest2
        filepaths = [
            dirpath + "/test_file_1.txt",
    ...
    def test_TemplateLibrary_loadAllTemplates_addFrameFromFile_TrueCheck(self):
        ...
        included in the class object and thus the method addFrameDirs is
        working fine tested"""
        ins_12= TL([PV_testdir_TemplateLibraryTest])
        ins_12.addFrameFromFile(PV_testdir_TemplateLibraryTest2 + "/test_file_4.txt")
        dirpath = PV_testdir_TemplateLibraryTest
        dirpath2 = PV_testdir_TemplateLibraryTest2
        filepaths = [
            dirpath + "/test_file_1.txt",
    ...
    def test_TemplateLibrary_loadAllTemplates_addFrameFromFile_FalseCheck(self):
        ...
        included in the class object and thus the method addFrameDirs is
        working fine tested"""
        ins_13= TL([PV_testdir_TemplateLibraryTest])
        ins_13.addFrameFromFile(PV_testdir_TemplateLibraryTest2 + "/test_file_10.txt")
        dirpath = PV_testdir_TemplateLibraryTest
        dirpath2 = PV_testdir_TemplateLibraryTest2
        filepaths = [
            dirpath + "/test_file_1.txt",
    ...
    def test_TemplateLibrary_frameObj_withExecSegments_getGeneratedCode(self):
        ...
        output_file_path = PV_testdir_Expected_Output_Examples + \
