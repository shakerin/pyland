...
class TestCommandLibrary:
    ...
    def test_CommandLibrary_loadFrameFilesFromDir_frame_dirs(self):
        ...
        ins = CL()
        ins.loadFrameFilesFromDir(PV_testdir_CommandLibraryTest)
        expected_frame_dirs = []
    ...
    def test_CommandLibrary_frame_dirs(self):
        ...
        ins_22= CL([PV_testdir_CommandLibraryTest])
        ins_22.addFrameDirs([PV_testdir_CommandLibraryTest2])
        exp_frame_dirs = [
            PV_testdir_CommandLibraryTest,
            PV_testdir_CommandLibraryTest2
        ]
    ...
    def test_CommandLibrary_loadFrameFilesFromDir_frame_files(self):
        ...
        expected_abspath_list = [join(PV_testdir_CommandLibraryTest, f) for f in expected_list] 
    ...
    def test_CommandLibrary_loadAllTemplates_frame_files(self):
        ...
        ins = CL([PV_testdir_CommandLibraryTest,PV_testdir_CommandLibraryTest2])
        expected_list = ["test_file_1.txt", "test_file_2.txt", "test_file_3"]
        expected_abspath_list = [join(PV_testdir_CommandLibraryTest, f) for f in expected_list] 
        expected_list1 = ["test_file_4.txt", "test_file_5.txt", "test_file_6"]
        expected_abspath_list1 = [join(PV_testdir_CommandLibraryTest2, f) for f in expected_list1]         
    ...
    def test_CommandLibrary_loadAllTemplates_frame_names(self):
        ...
        ins_4 = CL([PV_testdir_CommandLibraryTest,PV_testdir_CommandLibraryTest2])
    ...
    def test_CommandLibrary_loadAllTemplates_DynamicObjectInternalVariable_name(self):
        ...
        ins_5= CL([PV_testdir_CommandLibraryTest,PV_testdir_CommandLibraryTest2])
    ...
    def test_CommandLibrary_loadAllTemplates_DynamicObjectsCreated(self):
        ...
        ins_6= CL([PV_testdir_CommandLibraryTest])
    ...
    def test_CommandLibrary_loadAllTemplates_ListOfFrameFiles(self):
        ...
        ins_8= CL([PV_testdir_CommandLibraryTest])
        dirpath = PV_testdir_CommandLibraryTest
        filepaths = [
    ...
    def test_CommandLibrary_loadAllTemplates_DynamicObjects_FrameLocationSearch(self):
        ...
        ins_9 = CL([PV_testdir_CommandLibraryTest,PV_testdir_CommandLibraryTest2])
        assert ins_9.findFrame("test_file_6") == PV_testdir_CommandLibraryTest2+"/test_file_6" 
    ...
    def test_CommandLibrary_loadAllTemplates_DynamicObjectsUsage(self):
        ...
        ins_7= CL([PV_testdir_CommandLibraryTest])
    ...
    def test_CommandLibrary_loadAllTemplates_addFrameDirs_FalseCheck(self):
        ...
        ins_10= CL([PV_testdir_CommandLibraryTest])
        dirpath = PV_testdir_CommandLibraryTest
        dirpath2 = PV_testdir_CommandLibraryTest2
        filepaths = [
            dirpath + "/test_file_1.txt",
            dirpath + "/test_file_2.txt",
            dirpath + "/test_file_3",
    ...
    def test_CommandLibrary_loadAllTemplates_addFrameDirs_TrueCheck(self):
        ...
        working fine tested"""
        ins_11= CL([PV_testdir_CommandLibraryTest])
        ins_11.addFrameDirs([PV_testdir_CommandLibraryTest2])
        dirpath = PV_testdir_CommandLibraryTest
        dirpath2 = PV_testdir_CommandLibraryTest2
        filepaths = [
            dirpath + "/test_file_1.txt",
    ...
    def test_CommandLibrary_loadAllTemplates_addFrameFromFile_TrueCheck(self):
        ...
        included in the class object and thus the method addFrameDirs is
        working fine tested"""
        ins_12= CL([PV_testdir_CommandLibraryTest])
        ins_12.addFrameFromFile(PV_testdir_CommandLibraryTest2 + "/test_file_4.txt")
        dirpath = PV_testdir_CommandLibraryTest
        dirpath2 = PV_testdir_CommandLibraryTest2
        filepaths = [
            dirpath + "/test_file_1.txt",
    ...
    def test_CommandLibrary_loadAllTemplates_addFrameFromFile_FalseCheck(self):
        ...
        included in the class object and thus the method addFrameDirs is
        working fine tested"""
        ins_13= CL([PV_testdir_CommandLibraryTest])
        ins_13.addFrameFromFile(PV_testdir_CommandLibraryTest2 + "/test_file_10.txt")
        dirpath = PV_testdir_CommandLibraryTest
        dirpath2 = PV_testdir_CommandLibraryTest2
        filepaths = [
            dirpath + "/test_file_1.txt",
    ...
    def test_CommandLibrary_FrameObj_runGeneratedCode_WriteToAFile(self):
        ...
        """
        ins_14 = CL([PV_testdir_CommandLibraryTest])
        txt_2_write = "I am from the class test_CommandLibrary.py"
        ins_14.test_file_3.runGeneratedCode({
                                             'filepath' : PV_testdir_CommandLibraryTest2 + "/test_file_3",
                                             'txt' : txt_2_write
                                             })
        readTxt = ""
        with open(PV_testdir_CommandLibraryTest2+"/test_file_3", "r") as f:
            readTxt = f.read()
    ...
    def test_CommandLibrary_FrameObj_runGeneratedCode_ForLoop(self):
        ...
        """
        ins_15 = CL([PV_testdir_CommandLibraryTest])
    ...
    def test_CommandLibrary_runGeneratedCode_SimpleForLoop(self):
        ...
        command frame keywords : start, item, list_or_dict, do_cmd, end
        """
        ins_15 = CL([PV_testdir_CommandLibraryTest2])
